...
const globalStyle = {
  ...
  navigationBarBackgroundColor: "#f9f4dc",
...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.206.1",\n        "192.168.112.1",\n        "192.168.1.6"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "D:/HBuilderX.3.5.3.20220729/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"show","spaceId":"5211f308-b8e0-432e-abe3-85313b803a82","clientSecret":"jkkyfS0WWoWaM6tjcSeyTg==","endpoint":"https://api.bspapp.com"}]') || [];
let _ = "";
try {
  _ = "__UNI__DB932A9";
} catch (e2) {
