      ...
      <uni-list-item class="item">
        <template v-slot:body>
          <view class="item">
            ...
            <cloud-image @click="uploadAvatarImg" v-if="avatar_file" :src="avatar_file.url" width="100px"
              height="100px"></cloud-image>
            <uni-icons @click="uploadAvatarImg" v-else class="chooseAvatar" type="plusempty" size="30" color="#dddddd">
            </uni-icons>
          </view>
        </template>
      </uni-list-item>
